...
docker run -d --restart unless-stopped --name myadmin \
  ...
  -v /home/sv/conf_phpmyadmin/config.inc.php:/etc/phpmyadmin/config.user.inc.php:ro \
  -v /home/sv/conf_phpmyadmin/config4.inc.php:/etc/phpmyadmin40/config.user.inc.php:ro \
  uralm1/myadmin
